...
import { Rating, Grid, LinearProgress } from '@mui/material'
      ...
      <div className="pt-6">
        ...
        {/* Product info */}
                ...
                <div className="lg:col-span-2 ">
                    <h1 className="text-lg lg:text-x1 font-semibold text-gray-900"> Universalfit</h1>
                ...
                <div className="mt-4 lg:row-span-3 lg:mt-0">
                    ...
                    <div className="mt-6">
                      <div className='flex items-center space-x-3'> 
                        ...
                        <p className='opacity-50 text-sm '>56356 Ratings</p>
                        <p className='ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500'>5635 Reviews</p>
                      </div>
          ...
          <div className='border p-5'>
            ...
            <Grid container spacing={7}>
              ...
              <Grid item xs={5}>
                ...
                <div className='flex items-center space-x-3'mt-107777777>
                  <Rating value={4.6} precision={.5} readOnly/>
                  <p className='opacity-60'>5635 Ratings</p>
                </div>
