...
const OrderDetails = () => {
  return (
    <div className='px:5 lg:px-20'>
        ...
        <Grid contained className='space-y-5'>

            {[1,1,1,1,1].map((item)=><Grid item container className='shadow-x1 rounded-md p-5 border' sx={{alignItems:"center", justifyContent:'space-between'}}>
                <Grid item xs={6}>
